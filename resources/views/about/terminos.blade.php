...
@include('meta::manager', [
  'title'         => 'Términos Y Condiciones - Alejandro Aguilar',
        ...
        <div class="col-lg-12 mb-5 mb-lg-0">
          ...
          <div class="card border-0 shadow-sm mb-4 mb-lg-5 p-2 p-lg-0">
            <div class="card-body p-lg-5">
              <h1 class="h3 mb-4 text-center">Términos y Condiciones</h1>
              <h2 class="h4">Información Relevante</h2>
                ...
                <h2 class="h4">Licencia</h2>
              
              <p>Alejandro Aguilar  a través de su sitio web concede una licencia para que los usuarios utilicen  los productos que son vendidos en este sitio web de acuerdo a los Términos y Condiciones que se describen en este documento.</p>
              
              <h2 class="h4">Uso no Autorizado</h2>
              ...
              <h2 class="h4">Política de Reembolso y Garantía</h2>
              ...
              <h2 class="h4">Comprobación Antifraude</h2>
              ...
              <p>Este https://alejandroaguilar.dev garantiza que la información personal que usted envía cuenta con la seguridad necesaria. Los datos ingresados por usuario o en el caso de requerir una validación de los pedidos no serán entregados a terceros, salvo que deba ser revelada en cumplimiento a una orden judicial o requerimientos legales.</p>
                ...
                <p>Alejandro Aguilar reserva los derechos de cambiar o de modificar estos términos sin previo aviso.</p>
